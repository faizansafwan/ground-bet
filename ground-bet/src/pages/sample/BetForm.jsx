...
export default function AddForm({refreshSlots}) {
  ...
  const handleChange = (e) => {
    ...
    if (name === "donation") {
      ...
      const slots = donationAmount > 0 ? Math.ceil(donationAmount / 25000) : 1;
  ...
  return (
    <div>
      {!showForm && !isFormVisible && (
        <button onClick={handleShowForm} className="mb-4 px-4 py-2 bg-sky-400 text-white cursor-pointer rounded transition hover:bg-sky-500 duration-300 ease-in-out 
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between gap-4">
              <button
                ...
                transition ease-in-out duration-300 ${loading ? "bg-sky-300 cursor-not-allowed" : "bg-sky-400 hover:bg-sky-500"}`}
              >
